...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, GPIO_PIN_4|GPIO_PIN_2|GPIO_PIN_1, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PI6 PI2 PI0 */
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_2|GPIO_PIN_0;
  ...
  /*Configure GPIO pins : PG4 PG3 PG2 PG1 */
